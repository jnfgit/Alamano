...
public class EnvioCorreo {
	...
	/*public static void enviarCorreoPedidoRegistrado(Orden orden) throws AddressException, MessagingException {
		...
		mailMessage.setSubject(Properties.getParameter("pedidoRegistradoSubject"));
		
		String emailBody = Properties.getParameter("pedidoRegistradoBody").replace("#clienteNombre#",orden.getUsuario().getNombreCompleto());
	...
	public static void enviarCorreoConfirmarUsuario(String correo) throws AddressException, MessagingException {
		...
		String emailBody = Properties.getParameter("confirmarUsuarioBody").replace("#link#",prueba);
		*/
